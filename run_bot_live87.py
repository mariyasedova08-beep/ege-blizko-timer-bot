...
def _survey_question_markup(question):
    rows = [
        [InlineKeyboardButton(label, callback_data=f"cab:sv:a:{question['key']}:{code}")]
...
def verify_teacher_survey_wiring():
    ...
    print("LIVE87: teacher survey menu, deep link and answer routers verified", flush=True)
