...
HELP_TEXT = (
    "❓ <b>Краткая инструкция ПРЕПАДМИН</b>\n\n"
    "💗 <b>Главная ПРЕПАДМИН</b> — общий экран: ближайшие занятия, задачи, долги по ДЗ и оплате, зона внимания.\n\n"
    ...
    "🗓 <b>Мои слоты</b> — настрой рабочие часы; ПРЕПАДМИН покажет занятые и свободные окна и учтёт переносы.\n\n"
    ...
    for row in teachers:
        ...
        try:
            await context.bot.send_message(
                chat_id=uid,
                text=(
                    "❓ В ПРЕПАДМИН появилась краткая инструкция по всем основным функциям.\n\n"
