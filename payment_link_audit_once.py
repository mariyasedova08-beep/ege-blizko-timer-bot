...
def main():
    with sqlite3.connect(bot.COREAPP_DB_PATH) as conn:
        ...
        for label, email in TARGETS.items():
            ...
            for sid, display_name, user_name, telegram_username, has_telegram, active in name_rows:
                print(
            ...
            for telegram_id, (telegram_name, telegram_username) in poll_matches.items():
                print(
